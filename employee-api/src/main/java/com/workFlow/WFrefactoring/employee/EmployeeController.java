...
public class EmployeeController{
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "lastEmpNo", value = "마지막 조회 사원 번호", required = false, dataType = "Long", paramType = "query")
                    , @ApiImplicitParam(name = "pageSize", value = "조회 사원 수", required = false, dataType = "Integer", paramType = "query", defaultValue = "3")})
    @GetMapping
    ...
    @ApiImplicitParam(name = "empNo", value = "사원 아이디", required = true, dataType = "Long", paramType = "path", defaultValue = "None")
    @GetMapping("/{empNo}")
